...
```{r}
summary(dw.potability$ph)
summary(dw.potability$Hardness)
summary(dw.potability$Solids)
summary(dw.potability$Chloramines)
summary(dw.potability$Sulfate)
summary(dw.potability$Conductivity)
summary(dw.potability$Organic_carbon)
summary(dw.potability$Trihalomethanes)
summary(dw.potability$Turbidity)
```
...
>>>>>>> 5c5aa2fd092b5fa4cfb35f63004776222c1fa77e
