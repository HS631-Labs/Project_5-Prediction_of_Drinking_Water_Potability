...
# It appears that the linear models in the ph vs. Hardness and ph vs. Solids scatterplots display very different gradients when grouped by Not Potable and Potable
```
